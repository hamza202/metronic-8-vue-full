      ...
      <div id="kt_account_signin_method" class="collapse">
        ...
        <div class="card-body border-top p-9">
          ...
          <div class="row g-4">
            <div class="col-lg-6">
              <div class="field">
                <label class="d-block" for="email">{{ $t('label.name') }}</label>
                <InputText
                    id="name"
...
export default {
  ...
  data() {
    return {
      name: this.$t('name.funding-requests'),
      singularName: 'funding-request',
      routLink: 'funding-requests',
      filterFields: '',
      searchFields: {
        name: null,
        email: null,
  ...
  mounted() {
    setCurrentPageBreadcrumbs(this.name, ['Funding Request']);
  },
