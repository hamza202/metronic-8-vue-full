                        ...
                        <template v-for="(item, index) in items" :key="index">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="text-muted fw-semobold d-block fs-7">{{ item.info.description }}</span>
                                </td>
                                <td class="text-end">
                                    <template v-for="(item1, index1) in item.badges" :key="index1">
                                        <span :class="`badge-light-${item1.color}`" class="badge fw-semobold me-1">{{
                                            item1.label
                                        }}</span>
                                    </template>
                                </td>
