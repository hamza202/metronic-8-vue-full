    ...
    <div :class="widgetClasses" class="card">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                ...
                <span class="text-muted mt-1 fw-semobold fs-7">More than 100 new orders</span>
            </h3>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="symbol symbol-50px me-2">
                                                    <span :class="`bg-light-${item1.icon.color}`" class="symbol-label">
                                                        <span
                                            ...
                                            <td class="text-end">
                                                <span class="text-muted fw-semobold d-block fs-8">Ordered</span>

                                                <span class="text-dark fw-bold d-block fs-7">{{ item1.date }}</span>
                                            </td>
                                            <td class="text-end">
                                                <span
