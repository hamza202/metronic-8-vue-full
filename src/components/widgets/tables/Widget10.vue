    ...
    <div :class="widgetClasses" class="card">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                ...
                <span class="text-muted mt-1 fw-semobold fs-7">Over 500 new products</span>
            </h3>
                        ...
                        <template v-for="(item, index) in list" :key="index">
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-45px me-5">
                                            <img v-if="item.user.avatar" alt="Pic" :src="item.user.avatar" />
                                            <span
                                ...
                                <td class="text-end">
                                    ...
                                    <span class="text-muted fw-semobold text-muted d-block fs-7">Paid</span>
                                </td>
                                ...
                                <td class="text-end">
                                    <span :class="`badge-light-${item.status.color}`" class="badge">{{
                                        item.status.label
                                    }}</span>
                                </td>
