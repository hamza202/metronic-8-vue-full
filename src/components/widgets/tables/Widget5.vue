    ...
    <div class="card" :class="widgetClasses">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                ...
                <span class="text-muted mt-1 fw-semobold fs-7">More than 400 new products</span>
            </h3>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6"
                                            >Brad Simmons</a
                                        >
                                        <span class="text-muted fw-semobold d-block">Movie Creator</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6"
                                            >Popular Authors</a
                                        >
                                        <span class="text-muted fw-semobold d-block">Most Successful</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="text-muted fw-semobold d-block">Awesome Users</span>
                                    </td>
                                    <td class="text-end text-muted fw-semobold">Laravel,Metronic</td>
                                    <td class="text-end">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6"
                                            >Bestseller Theme</a
                                        >
                                        <span class="text-muted fw-semobold d-block">Best Customers</span>
                                    </td>
