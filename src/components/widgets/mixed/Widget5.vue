            ...
            <div class="mt-5">
                    ...
                    <div class="d-flex align-items-center me-2">
                        ...
                        <div class="symbol symbol-50px me-3">
                            <div class="symbol-label bg-light">
                                <img src="media/svg/brand-logos/plurk.svg" alt="" class="h-50" />
                            </div>
                        </div>
                        <!--end::Symbol-->
                        ...
                        <div>
                            ...
                            <div class="fs-7 text-muted fw-semobold mt-1">Ricky Hunt, Sandra Trepp</div>
                        </div>
                        <!--end::Title-->
                    </div>
                    <!--end::Section-->
                ...
                <div class="d-flex flex-stack mb-5">
                    ...
                    <div class="d-flex align-items-center me-2">
                        ...
                        <div class="symbol symbol-50px me-3">
                            <div class="symbol-label bg-light">
                                <img src="media/svg/brand-logos/figma-1.svg" alt="" class="h-50" />
                            </div>
                        </div>
                        <!--end::Symbol-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center me-2">
                        ...
                        <div class="symbol symbol-50px me-3">
                            <div class="symbol-label bg-light">
                                <img src="media/svg/brand-logos/vimeo.svg" alt="" class="h-50" />
                            </div>
                        </div>
                        <!--end::Symbol-->
