    ...
    <div class="card" :class="widgetClasses">
        ...
        <div class="card-header align-items-center border-0 mt-4">
            <h3 class="card-title align-items-start flex-column">
                ...
                <span class="text-muted mt-1 fw-semobold fs-7">Articles and publications</span>
            </h3>
        ...
        <div class="card-body pt-3">
            <template v-for="(item, index) in list" :key="index">
                <!--begin::Item-->
                <div :class="{ 'mb-7': list.length - 1 !== index }" class="d-flex align-items-sm-center">
                    <!--begin::Symbol-->
                    ...
                    <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                        <div class="flex-grow-1 me-2">
                            ...
                            <span class="text-muted fw-semobold d-block pt-1">Size: {{ item.size }}</span>
                        </div>

                        <span :class="`badge-light-${item.color}`" class="badge fs-8 fw-bold my-2">{{
                            item.status
                        }}</span>
                    </div>
                    <!--end::Title-->
