<template>
  <span v-bind="$attrs" @click="togglePicker" class="d-block">
...
.aim-icon-item.aesthetic-selected {
  -webkit-box-shadow: 0 1px 12px rgba(0, 0, 0, 0.05), 0 0 0 1px #009ef7;
  box-shadow: 0 1px 12px rgba(0, 0, 0, 0.05), 0 0 0 1px #009ef7;
}
.aim-icon-item-inner {
  display: -webkit-box;
  display: -ms-flexbox;
