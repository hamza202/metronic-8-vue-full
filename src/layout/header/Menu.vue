        ...
        >
                                ...
                                >
                                    <template v-for="(menuItem1, k) in menuItem.sub" :key="k">
                                        ...
                                        <div v-if="menuItem1.heading" class="menu-item">
                                            <router-link class="menu-link" active-class="active" :to="menuItem1.route">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
            ...
            >
                ...
                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                    <div class="menu-item">
                        <a class="menu-link py-3" href="https://preview.keenthemes.com/metronic8/vue/docs/#/utilities">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        ...
                        >
                            <span class="menu-icon">
                                <i v-if="headerMenuIcons === 'font'" class="bi bi-card-text fs-3"></i>
                                <span v-else-if="headerMenuIcons === 'svg'" class="svg-icon svg-icon-2">
                    ...
                    <div class="menu-item">
                        <a class="menu-link py-3" href="https://preview.keenthemes.com/metronic8/vue/docs/#/changelog">
                            <span class="menu-icon">
                                <i v-if="headerMenuIcons === 'font'" class="bi bi-journal-code fs-3"></i>
                                <span v-else-if="headerMenuIcons === 'svg'" class="svg-icon svg-icon-2">
