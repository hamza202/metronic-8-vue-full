    ...
    >
      <template v-for="(item, i) in MainMenuConfig" :key="i" >
          ...
          <template v-for="(menuItem, j) in item.pages" :key="j">
            <div v-if="permissions[menuItem.permission]?.can_view">
              <template v-if="menuItem.heading">
                <div class="menu-item">
                  <router-link :to="menuItem.route" active-class="active" class="menu-link">
                ...
                <div :class="{ show: hasActiveChildren(menuItem.route) }" class="menu-sub menu-sub-accordion">
                  <template v-for="(item2, k) in menuItem.sub" :key="k">
                    <div v-if="item2.heading" class="menu-item">
                      <router-link :to="item2.route" active-class="active" class="menu-link">
                      ...
                      >
                        <template v-for="(item3, k) in item2.sub" :key="k">
                          <div v-if="item3.heading" class="menu-item">
                            <router-link :to="item3.route" active-class="active" class="menu-link">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
...
export default defineComponent({
  ...
  setup() {
    ...
    const permissions: object = JSON.parse(JwtService.getPermissions() as string) || {};
